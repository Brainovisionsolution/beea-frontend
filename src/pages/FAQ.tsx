...
export default function FAQ() {
  ...
  return (
    <>
      <Navbar />
      <section id="faq" className="py-12 sm:py-16 md:py-20 bg-white relative overflow-hidden">
        {/* Subtle Decorative Elements */}
        <div className="absolute top-0 right-0 w-48 sm:w-64 md:w-96 h-48 sm:h-64 md:h-96 bg-[#D4AF37]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-48 sm:w-64 md:w-96 h-48 sm:h-64 md:h-96 bg-[#0B1C2D]/5 rounded-full blur-3xl"></div>
        
        {/* Decorative Gold Lines - Hidden on mobile */}
        <div className="hidden sm:block absolute top-40 left-0 w-px h-40 bg-gradient-to-b from-transparent via-[#D4AF37] to-transparent opacity-20"></div>
        <div className="hidden sm:block absolute bottom-40 right-0 w-px h-40 bg-gradient-to-t from-transparent via-[#D4AF37] to-transparent opacity-20"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          {/* Header - Enhanced Typography & Mobile Responsive */}
          <motion.div 
          ...
          >
            <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              />
              <span 
                className="font-heading text-[10px] sm:text-xs md:text-sm font-semibold tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.25em] uppercase"
            ...
            <motion.h2 
              ...
              className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-1 sm:mb-2"
            ...
            <motion.div 
              ...
              className="w-16 sm:w-20 h-0.5 mx-auto mb-3 sm:mb-4"
              style={{ 
            ...
            <motion.p 
              ...
              className="font-body text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4"
          ...
          {/* FAQ Grid - Responsive: 1 column on mobile, 2 on desktop */}
                ...
                return (
                  ...
                  >
                    <button 
                      ...
                      className="w-full px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center gap-2 sm:gap-4 text-left"
                    >
                      <span 
                        className="font-heading text-sm sm:text-base md:text-lg font-bold transition-colors duration-300 flex-1"
                        style={{ 
                      ...
                      >
                        <ChevronDown className={`flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 transition-colors duration-300 ${
                      ...
                      {openIndex === id && (
                        ...
                        >
                          <div className="px-4 sm:px-6 pb-3 sm:pb-4">
                            ...
                            />
                            <div className="font-body text-xs sm:text-sm leading-relaxed" style={{ color: '#4B5563', fontFamily: 'Poppins, sans-serif' }}>
                              {faq.answer}
                            </div>
                          </div>
                        </motion.div>
          ...
          {/* Still Have Questions? - Enhanced & Mobile Responsive */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.4 }}
          ...
          >
            <div 
              className="inline-block rounded-2xl p-6 sm:p-8 max-w-2xl w-full relative overflow-hidden"
              style={{ 
            ...
            >
              ...
              <div className="hidden sm:block absolute top-0 left-0 w-12 sm:w-16 h-12 sm:h-16 border-t-2 border-l-2 rounded-tl-2xl" style={{ borderColor: '#D4AF37', opacity: 0.3 }}></div>
              <div className="hidden sm:block absolute bottom-0 right-0 w-12 sm:w-16 h-12 sm:h-16 border-b-2 border-r-2 rounded-br-2xl" style={{ borderColor: '#D4AF37', opacity: 0.3 }}></div>
              
              <h3 className="font-heading text-xl sm:text-2xl font-bold mb-2" style={{ color: '#0B1C2D', fontFamily: 'Playfair Display, serif' }}>
                Still have questions?
              </h3>
              <p className="font-body text-xs sm:text-sm md:text-base mb-4 sm:mb-6 px-2" style={{ color: '#6B7280', fontFamily: 'Poppins, sans-serif' }}>
                Can't find the answer you're looking for? Please chat with our support team.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <motion.button 
                  className="px-4 sm:px-6 py-2.5 sm:py-3 font-heading font-semibold rounded-lg transition-all duration-300 text-sm sm:text-base"
                  style={{ 
            ...
            >
              <div className="flex items-center justify-center gap-2 sm:gap-3">
                ...
                <p className="font-body text-[10px] sm:text-xs" style={{ color: '#9CA3AF', fontFamily: 'Poppins, sans-serif' }}>
